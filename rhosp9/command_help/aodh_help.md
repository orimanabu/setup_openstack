...
```
usage: aodh alarm delete [-h] [--alarm-name <ALARM NAME>] [<ALARM ID>]
...
```
usage: aodh alarm list [-h] [-f {csv,html,json,json,table,value,yaml,yaml}]
                       [-c COLUMN] [--max-width <integer>] [--noindent]
...
```
usage: aodh alarm show [-h] [-f {html,json,json,shell,table,value,yaml,yaml}]
                       [-c COLUMN] [--max-width <integer>] [--noindent]
...
```
usage: aodh alarm-history search [-h]
...
```
usage: aodh alarm-history show [-h]
                               [-f {csv,html,json,json,table,value,yaml,yaml}]
                               [-c COLUMN] [--max-width <integer>]
                               [--noindent]
                               [--quote {all,minimal,none,nonnumeric}]
...
```
usage: aodh capabilities list [-h]
                              [-f {html,json,json,shell,table,value,yaml,yaml}]
                              [-c COLUMN] [--max-width <integer>] [--noindent]
                              [--prefix PREFIX]
