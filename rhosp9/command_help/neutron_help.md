...
positional arguments:
  BGP_PEER              ID or name of bgp_peer to delete.
...
positional arguments:
  BGP_SPEAKER           ID or name of bgp_speaker to delete.
...
optional arguments:
  ...
  --router ROUTER       Firewall associated router name or ID (requires FWaaS
...
positional arguments:
  FLAVOR                Name or ID of the flavor to associate.
...
positional arguments:
  FLAVOR                ID or name of flavor to delete.
...
positional arguments:
  SERVICE_PROFILE       ID or name of service_profile to delete.
...
```
usage: neutron flavor-profile-list [-h]
                                   [-f {csv,html,json,json,table,value,yaml,yaml}]
                                   [-c COLUMN] [--max-width <integer>]
                                   [--noindent]
                                   [--quote {all,minimal,none,nonnumeric}]
...
optional arguments:
  ...
  --tenant-id TENANT_ID
                        The owner tenant ID.
  --name NAME           Name of the health monitor to be created.
  --admin-state-down    Set admin state up to false.
  --expected-codes EXPECTED_CODES
                        The list of HTTP status codes expected in response
                        from the member to declare it healthy. This attribute
...
optional arguments:
  ...
  --request-format {json}
                        DEPRECATED! Only JSON request format is supported.
  --name NAME           Updated name of the health monitor.
```
...
positional arguments:
  L7POLICY              ID or name of l7policy to delete.
...
```
usage: neutron lbaas-l7policy-list [-h]
                                   [-f {csv,html,json,json,table,value,yaml,yaml}]
                                   [-c COLUMN] [--max-width <integer>]
                                   [--noindent]
                                   [--quote {all,minimal,none,nonnumeric}]
...
positional arguments:
  RULE                  ID or name of rule to delete.
  L7POLICY              ID or name of L7 policy this rule belongs to.
...
```
usage: neutron lbaas-l7rule-list [-h]
                                 [-f {csv,html,json,json,table,value,yaml,yaml}]
                                 [-c COLUMN] [--max-width <integer>]
                                 [--noindent]
                                 [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron lbaas-l7rule-show [-h]
                                 [-f {html,json,json,shell,table,value,yaml,yaml}]
                                 [-c COLUMN] [--max-width <integer>]
                                 [--noindent] [--prefix PREFIX]
                                 [--request-format {json}] [-D] [-F FIELD]
...
optional arguments:
  ...
  --name NAME           Name of the member to be created.
...
positional arguments:
  RBAC_POLICY           ID of rbac_policy to delete.
...
positional arguments:
  ENDPOINT_GROUP        ID or name of endpoint_group to delete.
