...
Positional arguments:
  <subcommand>
    ...
    create              Create baremetal resources (chassis, nodes, and
                        ports).
...
Positional arguments:
  <node>                Name or UUID of the node.
  <provision-state>     Supported states: 'deleted', 'provide', 'clean',
...
Positional arguments:
  <file>  File (.yaml or .json) containing descriptions of the resources to
