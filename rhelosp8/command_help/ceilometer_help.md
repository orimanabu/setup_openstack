...
Optional arguments:
  ...
  --project-id <ALARM_PROJECT_ID>
                                ...
                                by admin users).
  --user-id <ALARM_USER_ID>     User to associate with alarm (only settable by
                                admin users).
...
Optional arguments:
  -q <QUERY>, --query <QUERY>   key[op]data_type::value; list. data_type is
                                optional, but if supplied must be string,
                                integer, float, or boolean.
  --meter-links                 If specified, meter links will be generated.
  -l <NUMBER>, --limit <NUMBER>
...
Optional arguments:
  --project-id <SAMPLE_PROJECT_ID>
                                ...
                                by admin users).
  --user-id <SAMPLE_USER_ID>    User to associate with sample (only settable
                                by admin users).
