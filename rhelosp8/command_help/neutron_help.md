...
```
usage: neutron address-scope-delete [-h] [--request-format {json,xml}]
                                    ADDRESS_SCOPE

Delete an address scope.

positional arguments:
  ADDRESS_SCOPE         ID or name of address_scope to delete.
...
```
usage: neutron address-scope-list [-h]
...
```
usage: neutron address-scope-update [-h] [--request-format {json,xml}]
                                    [--name NAME]
                                    ADDRESS_SCOPE
...
optional arguments:
  ...
  --request-format {json,xml}
                        The XML or JSON request format.
  --name NAME           Name of the address scope to update.
```
...
```
usage: neutron cisco-credential-create [-h]
                                       [-f {html,json,json,shell,table,value,yaml,yaml}]
                                       [-c COLUMN] [--max-width <integer>]
                                       [--noindent] [--prefix PREFIX]
                                       [--request-format {json,xml}]
...
```
usage: neutron cisco-credential-list [-h]
                                     [-f {csv,html,json,json,table,value,yaml,yaml}]
                                     [-c COLUMN] [--max-width <integer>]
                                     [--noindent]
                                     [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron cisco-credential-show [-h]
                                     [-f {html,json,json,shell,table,value,yaml,yaml}]
                                     [-c COLUMN] [--max-width <integer>]
                                     [--noindent] [--prefix PREFIX]
                                     [--request-format {json,xml}] [-D]
...
```
usage: neutron cisco-network-profile-create [-h]
                                            [-f {html,json,json,shell,table,value,yaml,yaml}]
                                            [-c COLUMN]
                                            [--max-width <integer>]
                                            [--noindent] [--prefix PREFIX]
...
```
usage: neutron cisco-network-profile-list [-h]
                                          [-f {csv,html,json,json,table,value,yaml,yaml}]
                                          [-c COLUMN] [--max-width <integer>]
                                          [--noindent]
                                          [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron cisco-network-profile-show [-h]
                                          [-f {html,json,json,shell,table,value,yaml,yaml}]
                                          [-c COLUMN] [--max-width <integer>]
                                          [--noindent] [--prefix PREFIX]
                                          [--request-format {json,xml}] [-D]
...
```
usage: neutron cisco-policy-profile-list [-h]
                                         [-f {csv,html,json,json,table,value,yaml,yaml}]
                                         [-c COLUMN] [--max-width <integer>]
                                         [--noindent]
                                         [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron cisco-policy-profile-show [-h]
                                         [-f {html,json,json,shell,table,value,yaml,yaml}]
                                         [-c COLUMN] [--max-width <integer>]
                                         [--noindent] [--prefix PREFIX]
                                         [--request-format {json,xml}] [-D]
...
```
usage: neutron ext-list [-h] [-f {csv,html,json,json,table,value,yaml,yaml}]
                        [-c COLUMN] [--max-width <integer>] [--noindent]
                        [--quote {all,minimal,none,nonnumeric}]
                        [--request-format {json,xml}] [-D] [-F FIELD]
...
```
usage: neutron firewall-policy-list [-h]
                                    [-f {csv,html,json,json,table,value,yaml,yaml}]
                                    [-c COLUMN] [--max-width <integer>]
                                    [--noindent]
                                    [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron firewall-rule-list [-h]
                                  [-f {csv,html,json,json,table,value,yaml,yaml}]
                                  [-c COLUMN] [--max-width <integer>]
                                  [--noindent]
                                  [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron floatingip-list [-h]
                               [-f {csv,html,json,json,table,value,yaml,yaml}]
                               [-c COLUMN] [--max-width <integer>]
                               [--noindent]
                               [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron gateway-device-list [-h]
                                   [-f {csv,html,json,json,table,value,yaml,yaml}]
                                   [-c COLUMN] [--max-width <integer>]
                                   [--noindent]
                                   [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron lb-member-list [-h]
                              [-f {csv,html,json,json,table,value,yaml,yaml}]
                              [-c COLUMN] [--max-width <integer>] [--noindent]
                              [--quote {all,minimal,none,nonnumeric}]
                              [--request-format {json,xml}] [-D] [-F FIELD]
...
```
usage: neutron lb-pool-create [-h]
                              [-f {html,json,json,shell,table,value,yaml,yaml}]
                              [-c COLUMN] [--max-width <integer>] [--noindent]
                              [--prefix PREFIX] [--request-format {json,xml}]
                              [--tenant-id TENANT_ID] [--admin-state-down]
...
```
usage: neutron lbaas-listener-list [-h]
                                   [-f {csv,html,json,json,table,value,yaml,yaml}]
                                   [-c COLUMN] [--max-width <integer>]
                                   [--noindent]
                                   [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron lbaas-pool-create [-h]
                                 [-f {html,json,json,shell,table,value,yaml,yaml}]
                                 [-c COLUMN] [--max-width <integer>]
                                 [--noindent] [--prefix PREFIX]
                                 [--request-format {json,xml}]
...
```
usage: neutron lbaas-pool-list [-h]
                               [-f {csv,html,json,json,table,value,yaml,yaml}]
                               [-c COLUMN] [--max-width <integer>]
                               [--noindent]
                               [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron meter-label-list [-h]
                                [-f {csv,html,json,json,table,value,yaml,yaml}]
                                [-c COLUMN] [--max-width <integer>]
                                [--noindent]
                                [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron net-external-list [-h]
                                 [-f {csv,html,json,json,table,value,yaml,yaml}]
                                 [-c COLUMN] [--max-width <integer>]
                                 [--noindent]
                                 [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron net-gateway-list [-h]
                                [-f {csv,html,json,json,table,value,yaml,yaml}]
                                [-c COLUMN] [--max-width <integer>]
                                [--noindent]
                                [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron net-list [-h] [-f {csv,html,json,json,table,value,yaml,yaml}]
                        [-c COLUMN] [--max-width <integer>] [--noindent]
                        [--quote {all,minimal,none,nonnumeric}]
                        [--request-format {json,xml}] [-D] [-F FIELD]
...
```
usage: neutron nuage-netpartition-create [-h]
                                         [-f {html,json,json,shell,table,value,yaml,yaml}]
                                         [-c COLUMN] [--max-width <integer>]
                                         [--noindent] [--prefix PREFIX]
                                         [--request-format {json,xml}]
...
```
usage: neutron nuage-netpartition-list [-h]
                                       [-f {csv,html,json,json,table,value,yaml,yaml}]
                                       [-c COLUMN] [--max-width <integer>]
                                       [--noindent]
                                       [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron nuage-netpartition-show [-h]
                                       [-f {html,json,json,shell,table,value,yaml,yaml}]
                                       [-c COLUMN] [--max-width <integer>]
                                       [--noindent] [--prefix PREFIX]
                                       [--request-format {json,xml}] [-D]
...
```
usage: neutron port-list [-h] [-f {csv,html,json,json,table,value,yaml,yaml}]
                         [-c COLUMN] [--max-width <integer>] [--noindent]
                         [--quote {all,minimal,none,nonnumeric}]
                         [--request-format {json,xml}] [-D] [-F FIELD]
                         [-P SIZE] [--sort-key FIELD] [--sort-dir {asc,desc}]
...
optional arguments:
  ...
  --tenant-id TENANT_ID
                        The owner tenant ID.
  --max-kbps MAX_KBPS   max bandwidth in kbps.
  --max-burst-kbps MAX_BURST_KBPS
...
positional arguments:
  BANDWIDTH_LIMIT_RULE  ID of bandwidth_limit_rule to delete.
  QOS_POLICY            ID or name of the QoS policy.
...
```
usage: neutron qos-bandwidth-limit-rule-update [-h]
                                               [--request-format {json,xml}]
                                               [--max-kbps MAX_KBPS]
                                               [--max-burst-kbps MAX_BURST_KBPS]
                                               BANDWIDTH_LIMIT_RULE QOS_POLICY
...
positional arguments:
  POLICY                ID or name of policy to delete.
...
```
usage: neutron qos-policy-list [-h]
                               [-f {csv,html,json,json,table,value,yaml,yaml}]
                               [-c COLUMN] [--max-width <integer>]
                               [--noindent]
                               [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron qos-policy-update [-h] [--request-format {json,xml}]
...
```
usage: neutron queue-list [-h] [-f {csv,html,json,json,table,value,yaml,yaml}]
                          [-c COLUMN] [--max-width <integer>] [--noindent]
                          [--quote {all,minimal,none,nonnumeric}]
                          [--request-format {json,xml}] [-D] [-F FIELD]
...
```
usage: neutron quota-list [-h] [-f {csv,html,json,json,table,value,yaml,yaml}]
                          [-c COLUMN] [--max-width <integer>] [--noindent]
                          [--quote {all,minimal,none,nonnumeric}]
                          [--request-format {json,xml}]
...
optional arguments:
  ...
  --tenant-id TENANT_ID
                        The owner tenant ID.
  --type {network}      Type of the object that RBAC policy affects.
...
positional arguments:
  RBAC_POLICY           ID or name of rbac_policy to delete.
...
```
usage: neutron rbac-list [-h] [-f {csv,html,json,json,table,value,yaml,yaml}]
                         [-c COLUMN] [--max-width <integer>] [--noindent]
                         [--quote {all,minimal,none,nonnumeric}]
                         [--request-format {json,xml}] [-D] [-F FIELD]
                         [-P SIZE] [--sort-key FIELD] [--sort-dir {asc,desc}]
...
positional arguments:
  RBAC_POLICY           ID or name of rbac_policy to look up.
...
```
usage: neutron rbac-update [-h] [--request-format {json,xml}]
                           [--target-tenant TARGET_TENANT]
                           RBAC_POLICY
...
positional arguments:
  RBAC_POLICY           ID or name of rbac_policy to update.
...
```
usage: neutron router-update [-h] [--request-format {json,xml}] [--name NAME]
                             [--admin-state-up {True,False}]
                             [--distributed {True,False}]
                             ROUTER
...
```
usage: neutron security-group-list [-h]
                                   [-f {csv,html,json,json,table,value,yaml,yaml}]
                                   [-c COLUMN] [--max-width <integer>]
                                   [--noindent]
                                   [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron subnetpool-list [-h]
                               [-f {csv,html,json,json,table,value,yaml,yaml}]
                               [-c COLUMN] [--max-width <integer>]
                               [--noindent]
                               [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron vpn-ikepolicy-list [-h]
                                  [-f {csv,html,json,json,table,value,yaml,yaml}]
                                  [-c COLUMN] [--max-width <integer>]
                                  [--noindent]
                                  [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron vpn-ipsecpolicy-list [-h]
                                    [-f {csv,html,json,json,table,value,yaml,yaml}]
                                    [-c COLUMN] [--max-width <integer>]
                                    [--noindent]
                                    [--quote {all,minimal,none,nonnumeric}]
...
```
usage: neutron vpn-service-list [-h]
                                [-f {csv,html,json,json,table,value,yaml,yaml}]
                                [-c COLUMN] [--max-width <integer>]
                                [--noindent]
                                [--quote {all,minimal,none,nonnumeric}]
